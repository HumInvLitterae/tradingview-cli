...
22. `docs/plans/tradingview-cli-drawing-commands-v1-17.md`
23. `docs/plans/tradingview-cli-indicator-commands-v1-16.md`
...
30. `docs/plans/tradingview-cli-data-module-refactor-v1-10.md`
...
41. `docs/notes/next-agent-handoff-prompt-2026-04-21.md`
42. `.agents/PLANS.md`
43. `.agents/skills/continuity/SKILL.md` when the continuity skill is active
...
- the remaining deferred old CLI surfaces have been audited; `pine raw-compile`, bulk destructive commands, and generic UI automation remain deferred
