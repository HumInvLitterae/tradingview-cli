...
14. `docs/plans/tradingview-cli-alert-list-v1-9.md`
...
19. `docs/plans/tradingview-cli-diagnostic-read-commands-v1-4.md`
20. `docs/plans/tradingview-cli-chart-region-screenshot-v1-3.md`
21. `docs/plans/tradingview-cli-read-utilities-v1-2.md`
22. `docs/plans/tradingview-cli-read-provider-migration-v1-1.md`
23. `docs/plans/tradingview-cli-rust-v1.md`
24. `docs/notes/tradingview-mcp-investigation-2026-04-24.md`
25. `docs/plans/tradingview-cli-bootstrap-and-bridge-replacement.md`
26. `docs/notes/next-agent-handoff-prompt-2026-04-21.md`
27. `.agents/PLANS.md`
28. `.agents/skills/continuity/SKILL.md` when the continuity skill is active
