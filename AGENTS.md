...
16. `docs/plans/tradingview-cli-data-module-refactor-v1-10.md`
...
27. `docs/notes/next-agent-handoff-prompt-2026-04-21.md`
28. `.agents/PLANS.md`
29. `.agents/skills/continuity/SKILL.md` when the continuity skill is active
