...
21. `docs/plans/tradingview-cli-data-module-refactor-v1-10.md`
...
32. `docs/notes/next-agent-handoff-prompt-2026-04-21.md`
33. `.agents/PLANS.md`
34. `.agents/skills/continuity/SKILL.md` when the continuity skill is active
