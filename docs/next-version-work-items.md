...
verification. Alert management follows.
...
| 5 | Watchlists and alerts | List/ID reads and watchlist management verified, including a native disposable-list lifecycle. Alert management follows; retain unsupported Pine/Desktop capabilities. |
