...
groups. After official-MCP research annotations, 106 paths have semantics
and 63 do not. Validation coverage remains partial even for annotated paths.
...
| 2 | Analysis-related MCP reads; compare/snapshot, scanner scan and MCP screener and financial/earnings and news/document metadata complete | Support symbol selection and chart analysis with pagination completeness, partial-result, source and freshness guidance. |
