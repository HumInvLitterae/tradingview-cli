# Historical plan catalog

This catalog preserves the completed-work descriptions from the former plan
index. It is historical navigation, not current execution authority or release
status. Filenames in the catalog identify repository plans; most completed
plans are in this directory, while older records still in the parent directory
remain at their original paths. Use [current work](../README.md) to resume.
