...
- [ ] Add the `tv snapshot <SYMBOL>` CLI surface and validation.
- [ ] Implement Desktop-free snapshot orchestration.
- [ ] Add focused unit and CLI contract tests.
- [ ] Update user-facing docs and runtime skill guidance.
- [ ] Run the full validation listed in this plan.
- [ ] Commit the completed implementation.

## Surprises & Discoveries

- None yet. Record any implementation surprises here with concise evidence as work proceeds.
...
Not yet implemented. At completion, summarize the command surface, payload shape, tests, and any deferred follow-up.
...
No implementation evidence yet. Add concise transcripts here after focused tests and final validation pass.
