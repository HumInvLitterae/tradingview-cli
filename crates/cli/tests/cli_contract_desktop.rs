...
fn screener_filter_mutations_reject_invalid_inputs_before_connecting() {
    let missing_target = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&missing_target);
    assert_eq!(value["success"], false);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let conflicting_target = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&conflicting_target);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let modify_missing_target = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&modify_missing_target);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let modify_conflicting_target = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&modify_conflicting_target);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let modify_missing_range = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&modify_missing_range);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let modify_blank_option = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&modify_blank_option);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let modify_option_with_range = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&modify_option_with_range);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let modify_invalid_range = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&modify_invalid_range);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let add_blank_name = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&add_blank_name);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let add_missing_range = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&add_missing_range);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let clear_without_confirmation = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&clear_without_confirmation);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let same_index_reorder = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&same_index_reorder);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
}
...
fn screener_column_remove_rejects_invalid_inputs_before_connecting() {
    ...
    let blank_add_id = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&blank_add_id);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
    ...
    let invalid_params = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&invalid_params);
    assert_eq!(value["command"], "screener");
    assert_eq!(value["error"]["kind"], "validation");
}
...
fn watchlist_add_bulk_rejects_invalid_inputs_before_connecting() {
    ...
    let bad_delay = tv()
        ...
        .failure()
        .code(1);
    let value = stderr_json(&bad_delay);
    assert_eq!(value["command"], "watchlist");
    assert_eq!(value["error"]["kind"], "validation");
