...
`1m`, `5m`, `15m`, `30m`, `1h`, `4h`, `1D`, `1W` and `1M` reads.
Minute `1m` differs from monthly `1M`; no local resampling occurs. Read `mcp_bars.v1` provider/client observations: count satisfaction
