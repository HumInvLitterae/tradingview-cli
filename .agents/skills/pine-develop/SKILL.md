...
| Read current editor or saved list | `tv pine get`, `tv pine errors`, `tv pine console`, `tv pine list` | Resolve the [Desktop session](../chart-analysis/references/desktop-session.md) if needed. |
