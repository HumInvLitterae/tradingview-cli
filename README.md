...
such as `v0.10.0` publish native archives like:

- `tv-v0.10.0-x86_64-unknown-linux-gnu.tar.gz`
- `tv-v0.10.0-x86_64-apple-darwin.tar.gz`
- `tv-v0.10.0-aarch64-apple-darwin.tar.gz`
- `tv-v0.10.0-x86_64-pc-windows-msvc.zip`
- `SHA256SUMS`
