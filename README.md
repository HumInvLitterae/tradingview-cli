...
- TradingView Stock Screener dialog reads and guarded filter cleanup through `tv screener status/open/get/screens active/filters list/remove/clear/columns list/close`
