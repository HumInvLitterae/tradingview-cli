...
GitHub Releases are the first supported binary distribution path. Pushing a version tag such as `v0.4.0` creates release assets named:

- `tv-v0.4.0-x86_64-unknown-linux-gnu.tar.gz`
- `tv-v0.4.0-x86_64-apple-darwin.tar.gz`
- `tv-v0.4.0-aarch64-apple-darwin.tar.gz`
- `tv-v0.4.0-x86_64-pc-windows-msvc.zip`
- `SHA256SUMS`
...
- a `v0.3.0` roadmap and release-readiness record at `docs/v0.3-roadmap.md`,
  plus a `v0.4.0` roadmap and release-readiness record at
